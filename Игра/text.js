var works = {
    ...
    d00: 'Внезапно, рядом с Вами, открывается портал и из него выскакивает огромный фиолетовый великан с большой дубиной.\n' +
    'По-началу он озирается по сторонам, пока не увидел маленькое существо, которым являлись Вы. Вы:\n',
    d0: 2, 
    d1: '1 - Сделаете вид, что Вы неодушевлённый предмет\n',
    d2: '2 - Пригласите отобедать\n',
};
